...
public class Ecuador extends GameActivity
{
	...
	ArrayList<String[]> wordListArray; // KRP // the full list of words
	ArrayList<String[]> searchCollection = new ArrayList(); // KRP // the correct word plus the seven incorrect words
...
//            LOGGER.info("Remember: currentBoxIndex =" + currentBoxIndex + " and extraLoops = " + extraLoops);
	...
	public void buildWordsArray()
	{
		...
		// updated module by KRP, Oct 2020
